...
class HumanSkeleton(
	...
	val leftLowerArmBone = Bone(BoneType.LEFT_LOWER_ARM, Constraint(ConstraintType.TWIST_SWING, 120f, 180f))
	val rightLowerArmBone = Bone(BoneType.RIGHT_LOWER_ARM, Constraint(ConstraintType.TWIST_SWING, 120f, 180f))
